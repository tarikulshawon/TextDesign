...
class ExampleCropViewController: IGRPhotoTweakViewController {
    ...
    override open func setupThemes() {
        IGRCropMaskView.appearance().backgroundColor = UIColor.white
        IGRPhotoTweakView.appearance().backgroundColor = UIColor.white
        IGRCropGridLine.appearance().backgroundColor = titleColor
        IGRCropLine.appearance().backgroundColor = titleColor
    }
